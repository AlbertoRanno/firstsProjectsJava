...
public class UsuarioJDBC {
    ...
    //La conexion se debe manejar de manera externa para logra una transaccion (sin cortes)
    ...
    //Creo los constructores para el caso de conexion transaccional:
    public UsuarioJDBC() {
    }
    ...
    public List<Usuario> seleccionar() throws SQLException {
        ...
        try {
            //aplico los condicionales ternarios para que manejen ambos casos de conexion:
            ...
            //Cambio de que procesen la excepcion, a que la propaguen
...
//            ex.printStackTrace(System.out);
            ...
            try {
                close(rs);
                close(stmt);
                //Agrego los condicionales a los cierre
