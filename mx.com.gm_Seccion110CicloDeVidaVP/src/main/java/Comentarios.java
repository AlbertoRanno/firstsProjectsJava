...
en cada una de las clasesDao, se hace una clase padre abstracta (para que no se puedan crear objetos directos de ella),
...
me encontre con el problema de que por ejemplo, si inserto un nuevo domicilio, este se inserta, pero luego da error, esto
sucede porque lo quise listar, y luego de la insercion, debido al close, la conexion se cerro antes de listar.
Particularmente podria comentar los close, ponerle solo el close a listar, u otras variantes, pero la realidad, es que
con Spring, ese problema no lo voy a tener, dado que va a manejar las conexiones de forma automatica, y optima, por lo
que avanzo para llegar mas rapido a spring
